...
class ColumnsControllerTest < ActionController::TestCase
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post :create, column: { page_id: @column.page_id, position: @column.position, span_width: @column.span_width }
    end
  ...
  test "should update column" do
    put :update, id: @column, column: { page_id: @column.page_id, position: @column.position, span_width: @column.span_width }
    assert_redirected_to column_path(assigns(:column))
  end
